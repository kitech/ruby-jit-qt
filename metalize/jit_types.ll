...
define void @_Z16__keep_jit_typesv() #0 {
  ...
  %146 = bitcast i8* %145 to %class.YaQWidget*
  %147 = load i8** %v0, align 4
  %148 = bitcast i8* %147 to %class.QWidget*
  %149 = load i8** %v0, align 4
  %150 = bitcast i8* %149 to %class.YaQMainWindow*
  %151 = load i8** %v0, align 4
  %152 = bitcast i8* %151 to %class.QMainWindow*
  %153 = load i8** %v0, align 4
  %154 = bitcast i8* %153 to %class.YaQPushButton*
  %155 = load i8** %v0, align 4
  %156 = bitcast i8* %155 to %class.QPushButton*
  %157 = load i8** %v0, align 4
  %158 = bitcast i8* %157 to %class.YaQApplication*
  %159 = load i8** %v0, align 4
  %160 = bitcast i8* %159 to %class.QApplication*
  ret void
}
