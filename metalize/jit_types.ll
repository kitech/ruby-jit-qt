...
%class.QColor.base = type <{ i32, %union.anon.12 }>
%union.anon.12 = type { %struct.anon }
%struct.anon = type { i16, i16, i16, i16, i16 }
%class.QColor = type { i32, %union.anon.12 }
%class.YaQPalette = type { %class.QPalette.base, [4 x i8] }
%class.QPalette.base = type <{ %class.QPalettePrivate*, %union.anon.11 }>
...
%class.QLayoutItem.base = type <{ i32 (...)**, %class.QFlags.16 }>
...
define void @_Z16__keep_jit_typesv() #0 {
  ...
  %158 = bitcast i8* %157 to %class.YaQColor*
  %159 = load i8** %v0, align 8
  %160 = bitcast i8* %159 to %class.QColor*
  %161 = load i8** %v0, align 8
  %162 = bitcast i8* %161 to %class.YaQPalette*
  %163 = load i8** %v0, align 8
  %164 = bitcast i8* %163 to %class.QPalette*
  %165 = load i8** %v0, align 8
  %166 = bitcast i8* %165 to %class.YaQRect*
  %167 = load i8** %v0, align 8
  %168 = bitcast i8* %167 to %class.QRect*
  %169 = load i8** %v0, align 8
  %170 = bitcast i8* %169 to %class.YaQRegion*
  %171 = load i8** %v0, align 8
  %172 = bitcast i8* %171 to %class.QRegion*
  %173 = load i8** %v0, align 8
  %174 = bitcast i8* %173 to %class.YaQLabel*
  %175 = load i8** %v0, align 8
  %176 = bitcast i8* %175 to %class.QLabel*
  %177 = load i8** %v0, align 8
  %178 = bitcast i8* %177 to %class.YaQPoint*
  %179 = load i8** %v0, align 8
  %180 = bitcast i8* %179 to %class.QPoint*
  %181 = load i8** %v0, align 8
  %182 = bitcast i8* %181 to %class.YaQFrame*
  %183 = load i8** %v0, align 8
  %184 = bitcast i8* %183 to %class.QFrame*
  %185 = load i8** %v0, align 8
  %186 = bitcast i8* %185 to %class.YaQPushButton*
  %187 = load i8** %v0, align 8
  %188 = bitcast i8* %187 to %class.QPushButton*
  %189 = load i8** %v0, align 8
  %190 = bitcast i8* %189 to %class.YaQLCDNumber*
  %191 = load i8** %v0, align 8
  %192 = bitcast i8* %191 to %class.QLCDNumber*
  %193 = load i8** %v0, align 8
  %194 = bitcast i8* %193 to %class.YaQSlider*
  %195 = load i8** %v0, align 8
  %196 = bitcast i8* %195 to %class.QSlider*
  %197 = load i8** %v0, align 8
  %198 = bitcast i8* %197 to %class.YaQLayout*
  %199 = load i8** %v0, align 8
  %200 = bitcast i8* %199 to %class.QLayout*
  %201 = load i8** %v0, align 8
  %202 = bitcast i8* %201 to %class.YaQBoxLayout*
  %203 = load i8** %v0, align 8
  %204 = bitcast i8* %203 to %class.QBoxLayout*
  %205 = load i8** %v0, align 8
  %206 = bitcast i8* %205 to %class.YaQGridLayout*
  %207 = load i8** %v0, align 8
  %208 = bitcast i8* %207 to %class.QGridLayout*
  %209 = load i8** %v0, align 8
  %210 = bitcast i8* %209 to %class.YaQApplication*
  %211 = load i8** %v0, align 8
  %212 = bitcast i8* %211 to %class.QApplication*
  %213 = load i8** %v0, align 8
  %214 = bitcast i8* %213 to %class.QVBoxLayout*
  %215 = load i8** %v0, align 8
  %216 = bitcast i8* %215 to %class.QHBoxLayout*
  %217 = load i8** %v0, align 8
  %218 = bitcast i8* %217 to %class.QDate*
  %219 = load i8** %v0, align 8
  %220 = bitcast i8* %219 to %class.QTime*
  ret void
}
