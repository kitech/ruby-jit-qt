...
define void @_Z16__keep_jit_typesv() #0 {
  ...
  %182 = bitcast i8* %181 to %class.YaQPushButton*
  %183 = load i8** %v0, align 8
  %184 = bitcast i8* %183 to %class.QPushButton*
  %185 = load i8** %v0, align 8
  %186 = bitcast i8* %185 to %class.YaQLCDNumber*
  %187 = load i8** %v0, align 8
  %188 = bitcast i8* %187 to %class.QLCDNumber*
  %189 = load i8** %v0, align 8
  %190 = bitcast i8* %189 to %class.YaQSlider*
  %191 = load i8** %v0, align 8
  %192 = bitcast i8* %191 to %class.QSlider*
  %193 = load i8** %v0, align 8
  %194 = bitcast i8* %193 to %class.YaQLayout*
  %195 = load i8** %v0, align 8
  %196 = bitcast i8* %195 to %class.QLayout*
  %197 = load i8** %v0, align 8
  %198 = bitcast i8* %197 to %class.YaQBoxLayout*
  %199 = load i8** %v0, align 8
  %200 = bitcast i8* %199 to %class.QBoxLayout*
  %201 = load i8** %v0, align 8
  %202 = bitcast i8* %201 to %class.YaQGridLayout*
  %203 = load i8** %v0, align 8
  %204 = bitcast i8* %203 to %class.QGridLayout*
  %205 = load i8** %v0, align 8
  %206 = bitcast i8* %205 to %class.YaQApplication*
  %207 = load i8** %v0, align 8
  %208 = bitcast i8* %207 to %class.QApplication*
  %209 = load i8** %v0, align 8
  %210 = bitcast i8* %209 to %class.QVBoxLayout*
  %211 = load i8** %v0, align 8
  %212 = bitcast i8* %211 to %class.QHBoxLayout*
  %213 = load i8** %v0, align 8
  %214 = bitcast i8* %213 to %class.QDate*
  %215 = load i8** %v0, align 8
  %216 = bitcast i8* %215 to %class.QTime*
  ret void
}
